    ...
    <div ref={containerRef} className="relative">
      ...
      {isOpen && (
        <div
          role="menu"
          aria-label={t(locale, "hotkeys_title")}
          className="absolute right-0 top-full mt-2 z-50 flex flex-col gap-3 rounded-sm border-2 border-rust bg-chrome-bg/95 p-3 shadow-[0_8px_24px_rgba(0,0,0,0.85)] backdrop-blur-md w-[320px] sm:w-[380px] fixed! right-3! sm:right-4! top-20! max-w-[calc(100vw-1.5rem)]! max-h-[calc(100vh-6rem)]! overflow-y-auto!"
        >
