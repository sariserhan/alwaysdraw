    ...
    <div ref={containerRef} className="relative">
      ...
      {isOpen && (
        <div
          ...
          className="fixed right-3 sm:right-4 min-[1360px]:right-[228px] top-20 z-[1000] flex flex-col gap-3 rounded-sm border-2 border-rust bg-chrome-bg/95 p-3 shadow-[0_12px_36px_rgba(0,0,0,0.9)] backdrop-blur-md w-[320px] sm:w-[360px] max-w-[calc(100vw-1.5rem)] max-h-[calc(100vh-6rem)] overflow-y-auto"
        >
