    ...
    <div ref={containerRef} className="relative">
      ...
      {isOpen && (
        <div
          role="menu"
          aria-label={t(locale, "display_name")}
          className="fixed right-3 sm:right-4 min-[1360px]:right-[228px] top-20 z-50 flex flex-col gap-2 rounded-sm border-2 border-rust bg-chrome-bg/95 p-3 shadow-[0_12px_36px_rgba(0,0,0,0.9)] backdrop-blur-md w-[260px] max-w-[calc(100vw-1.5rem)] max-h-[calc(100vh-6rem)] overflow-y-auto"
        >
