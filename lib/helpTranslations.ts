...
export const HELP_TRANSLATIONS: Record<Locale, HelpTranslation> = {
  en: {
    ...
    categories: {
      ...
      creativeToolsDesc: "Spray industrial stencils (T), measure distances (R), or shine laser trails (L).",
  ...
  fr: {
    ...
    categories: {
      ...
      creativeToolsDesc: "Mesurez avec la règle (R), pochoirs (T) ou laser (L).",
  ...
  ar: {
    ...
    categories: {
      ...
      creativeToolsDesc: "استخدم المسطرة (R)، الاستنسل (T) والليزر (L).",
  ...
  ru: {
    ...
    categories: {
      ...
      creativeToolsDesc: "Линейка (R), трафареты (T) и лазерный след (L).",
  ...
  es: {
    ...
    categories: {
      ...
      creativeToolsDesc: "Mide con la regla (R), plantillas (T) y láser (L).",
  ...
  pt: {
    ...
    categories: {
      ...
      creativeToolsDesc: "Meça com a régua (R), moldes (T) e laser (L).",
  ...
  tr: {
    ...
    categories: {
      ...
      creativeToolsDesc: "Cetvelle ölçün (R), şablon (T) ve lazer (L) kullanın.",
  ...
  ja: {
    ...
    categories: {
      ...
      creativeToolsDesc: "定規（R）、ステンシル（T）、レーザー（L）。",
