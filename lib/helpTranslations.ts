...
export const HELP_TRANSLATIONS: Record<Locale, HelpTranslation> = {
  en: {
    ...
    categories: {
      ...
      creativeToolsTitle: "🪄 Special Creative Tools",
      creativeToolsDesc: "Tap to flood fill enclosed areas (F). Spray industrial stencils (T), measure distances (R), or shine laser trails (L).",
  ...
  fr: {
    ...
    categories: {
      ...
      creativeToolsTitle: "🪄 Outils Créatifs",
      creativeToolsDesc: "Remplissage par pot de peinture (F). Mesurez avec la règle (R), pochoirs (T) ou laser (L).",
  ...
  ar: {
    ...
    categories: {
      ...
      creativeToolsDesc: "تعبئة سريعة (F). استخدم المسطرة (R)، الاستنسل (T) والليزر (L).",
  ...
  ru: {
    ...
    categories: {
      ...
      creativeToolsTitle: "🪄 Творческие инструменты",
      creativeToolsDesc: "Быстрая заливка областей (F). Линейка (R), трафареты (T) и лазерный след (L).",
  ...
  es: {
    ...
    categories: {
      ...
      creativeToolsTitle: "🪄 Herramientas Creativas",
      creativeToolsDesc: "Relleno de pintura (F). Mide con la regla (R), plantillas (T) y láser (L).",
  ...
  pt: {
    ...
    categories: {
      ...
      creativeToolsTitle: "🪄 Ferramentas Criativas",
      creativeToolsDesc: "Preenchimento por balde (F). Meça com a régua (R), moldes (T) e laser (L).",
  ...
  tr: {
    ...
    categories: {
      ...
      creativeToolsTitle: "🪄 Yaratıcı Araçlar",
      creativeToolsDesc: "Kapalı alanları tek tıkla doldurun (F). Cetvelle ölçün (R), şablon (T) ve lazer (L) kullanın.",
  ...
  ja: {
    ...
    categories: {
      ...
      creativeToolsTitle: "🪄 クリエイティブツール",
      creativeToolsDesc: "ワンタップで領域を塗りつぶし（F）。定規（R）、ステンシル（T）、レーザー（L）。",
